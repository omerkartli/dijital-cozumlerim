...
- **Bu repo**: statik sayfalar, build adımı yok — düz HTML/CSS/JS.
  GitHub Pages'e deploy oluyor. `kisisel-sayfam` reposundan 23 Eylül 2026'da
  ayrıldı; kişisel sayfa orada kaldı ve ürün sayfaları için oradan
